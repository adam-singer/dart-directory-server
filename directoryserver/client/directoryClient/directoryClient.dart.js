...
Isolate.$defineClass("LinkedHashMapImplementation", "Object", ["_map", "_list"], {
 ...
 forEach$1: function(f) {
  var t0 = ({});
  t0.f_1 = f;
  $.forEach(this._list, new $.Closure8(t0));
 },
 operator$index$1: function(key) {
...
Isolate.$defineClass("DoubleLinkedQueue", "Object", ["_sentinel"], {
 ...
 get$length: function() {
  var t0 = ({});
  t0.counter_1 = 0;
  this.forEach$1(new $.Closure7(t0));
  return t0.counter_1;
 },
 ...
 get$first: function() { return new $.Closure21(this); },
...
Isolate.$defineClass("ConstantMap", "Object", ["_lib2_keys?", "_jsObject", "length?"], {
 ...
 forEach$1: function(f) {
  var t0 = ({});
  t0.f_1 = f;
  $.forEach(this._lib2_keys, new $.Closure13(this, t0));
 },
 operator$index$1: function(key) {
...
Isolate.$defineClass("DirectoryModel", "Object", ["onMessage=", "_ws"], {
 sendMessage$1: function(message) {
  if ($.isEmpty(message) !== true) {
    this.get$ws().send$1($.stringify(message));
  }
 },
...
Isolate.$defineClass("DirectoryView", "Object", ["_dirInput?", "_directoryController?", "_filesDisplayElement"], {
 _displayDir$1: function(dir) {
  var t0 = ({});
  t0.dir_1 = dir;
  ...
  $.add$1(f.get$elements(), $.Element$html('<br/>'));
  $.add$1(b.get$on().get$click(), new $.Closure12(this, t0));
  $.add$1(this._filesDisplayElement.get$elements(), f);
 },
 get$_displayDir: function() { return new $.Closure23(this); },
 _displayFile$1: function(file) {
  var t0 = ({});
  t0.file_1 = file;
  ...
  $.add$1(f.get$elements(), b);
  $.add$1(f.get$elements(), $.Element$html('<br/>'));
  $.add$1(b.get$on().get$click(), new $.Closure14(this, t0));
  $.add$1(this._filesDisplayElement.get$elements(), f);
 },
 get$_displayFile: function() { return new $.Closure24(this); },
 _displayCwd$1: function(cwd) {
  var c = $.Element$html('<li>' + $.stringToString(cwd) + '</li>');
  $.add$1(this._filesDisplayElement.get$elements(), c);
  this._dirInput.set$value(cwd);
 },
 displayFiles$1: function(jsonFiles) {
  $.clear(this._filesDisplayElement.get$elements());
  this._displayCwd$1($.index(jsonFiles, 'cwd'));
  $.forEach($.index(jsonFiles, 'files'), this.get$_displayFile());
  $.forEach($.index(jsonFiles, 'dirs'), this.get$_displayDir());
 },
 get$displayFiles: function() { return new $.Closure25(this); },
 setupUserInputEvents$0: function() {
  this._dirInput = $.document().query$1('#dirInput');
  $.add$1(this._dirInput.get$on().get$keyPress(), new $.Closure(this));
 },
 addController$1: function(controller) {
  this._directoryController = controller;
 },
 DirectoryView$0: function() {
  this._filesDisplayElement = $.document().query$1('#filesDisplay');
 }
});

Isolate.$defineClass("DirectoryController", "Object", ["_directoryModel", "_directoryView"], {
 displayFile$1: function(fileName) {
  var f = $.makeLiteralMap(['displayFile', fileName]);
  this._directoryModel.sendMessage$1(f);
 },
 DirectoryController$2: function(model, view) {
  this._directoryView = view;
  this._directoryModel = model;
  this._directoryView.addController$1(this);
  var t0 = this._directoryView.get$displayFiles();
  this._directoryModel.set$onMessage(t0);
  this._directoryModel.setupWebsocket$0();
  this._directoryView.setupUserInputEvents$0();
 }
});
...
Isolate.$defineClass("FilteredElementList", "Object", ["_childNodes", "_node"], {
 ...
 removeRange$2: function(start, rangeLength) {
  $.forEach($.getRange(this.get$_filtered(), start, rangeLength), new $.Closure17());
 },
 addLast$1: function(value) {
  this.add$1(value);
 },
 ...
 get$add: function() { return new $.Closure27(this); },
 ...
 get$_filtered: function() {
  return $.List$from($.filter(this._childNodes, new $.Closure15()));
 },
...
Isolate.$defineClass("_ChildrenElementList", "Object", ["_childElements", "_lib_element?"], {
 ...
 filter$1: function(f) {
  ...
  t0.f_1 = f;
  var output = [];
  this.forEach$1(new $.Closure16(t0, output));
            ...
            if (typeof object === 'string') {
              ...
              if (typeof object === 'object' && (object.constructor === Array || object.is$List2())) {
                ...
                if (typeof object === 'object' && object.is$Map()) {
                  ...
                  $.add$1(this._sb, '{');
                  t0.first_1 = true;
                  object.forEach$1(new $.Closure6(this, t0));
                  $.add$1(this._sb, '}');
                  $.removeLast(this._seen);
                  return;
                } else {
...
Isolate.$defineClass("Closure", "Closure22", ["this_0"], {
 $call$1: function(key) {
  if ($.eqB(key.get$charCode(), 13)) {
    if (!$.eqNullB(this.this_0.get$_directoryController())) {
      this.this_0.get$_directoryController().displayFile$1(this.this_0.get$_dirInput().get$value());
    }
  }
 }
});

Isolate.$defineClass("Closure2", "Closure22", ["box_0"], {
 $call$2: function(k, v) {
...
Isolate.$defineClass("Closure3", "Closure22", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$0();
 }
});

Isolate.$defineClass("Closure4", "Closure22", ["box_0"], {
 $call$0: function() {
...
Isolate.$defineClass("Closure6", "Closure22", ["this_2", "box_0"], {
...
Isolate.$defineClass("Closure8", "Closure22", ["box_0"], {
...
Isolate.$defineClass("Closure10", "Closure22", [], {
 $call$1: function(c) {
  $.print('close ' + $.stringToString(c));
 }
});

Isolate.$defineClass("Closure11", "Closure22", ["this_0"], {
 $call$1: function(message) {
  var jsonFiles = $.parse(message.get$data());
  var t0 = this.this_0.get$onMessage();
  if (typeof t0 === 'function' || typeof t0 === 'object' && !!t0.is$Function) {
    this.this_0.onMessage$1(jsonFiles);
  }
 }
});

Isolate.$defineClass("Closure12", "Closure22", ["this_2", "box_0"], {
 $call$1: function(event$) {
  this.this_2.get$_directoryController().displayFile$1(this.box_0.dir_1);
 }
});

Isolate.$defineClass("Closure13", "Closure22", ["this_2", "box_0"], {
 $call$1: function(key) {
  return this.box_0.f_1.$call$2(key, $.index(this.this_2, key));
 }
});

Isolate.$defineClass("Closure14", "Closure22", ["this_2", "box_0"], {
 $call$1: function(event$) {
  this.this_2.get$_directoryController().displayFile$1(this.box_0.file_1);
  $.print(event$);
 }
});

Isolate.$defineClass("Closure15", "Closure22", [], {
 $call$1: function(n) {
  return typeof n === 'object' && n.is$Element();
 }
});

Isolate.$defineClass("Closure16", "Closure22", ["box_0", "output_2"], {
 $call$1: function(element) {
...
Isolate.$defineClass("Closure17", "Closure22", [], {
 $call$1: function(el) {
  return el.remove$0();
 }
});
...
Isolate.$defineClass('Closure21', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.first$0();
},
});
Isolate.$defineClass('Closure23', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$1: function(arg0) {
  return this.self._displayDir$1(arg0);
},
});
Isolate.$defineClass('Closure24', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$1: function(arg0) {
  return this.self._displayFile$1(arg0);
},
});
Isolate.$defineClass('Closure25', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$1: function(arg0) {
  return this.self.displayFiles$1(arg0);
},
});
Isolate.$defineClass('Closure26', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure27', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$1: function(arg0) {
  return this.self.add$1(arg0);
},
});
Isolate.$defineClass('Closure28', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.click$0();
},
});
Isolate.$defineClass('Closure29', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.click$0();
},
});
Isolate.$defineClass('Closure30', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure31', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure32', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$1: function(arg0) {
  return this.self.open$1(arg0);
},
});
Isolate.$defineClass('Closure33', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure34', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure35', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure36', 'Closure22', function BoundClosure(self) { this.self = self; }, {
...
Isolate.$defineClass('Closure37', 'Closure22', function BoundClosure(self) { this.self = self; }, {
...
Isolate.$defineClass('Closure38', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure39', 'Closure22', function BoundClosure(self) { this.self = self; }, {
$call$0: function() {
  return this.self.close$0();
},
});
Isolate.$defineClass('Closure40', 'Closure22', function BoundClosure(self) { this.self = self; }, {
...
$.DirectoryController$2 = function(model, view) {
  var t0 = new $.DirectoryController((void 0), (void 0));
  t0.DirectoryController$2(model, view);
  return t0;
};
...
$.main = function() {
  var _directoryView = $.DirectoryView$0();
  $.DirectoryController$2($.DirectoryModel$0(), _directoryView);
};
...
$.DirectoryView$0 = function() {
  var t0 = new $.DirectoryView((void 0), (void 0), (void 0));
  t0.DirectoryView$0();
  return t0;
};
...
$.DirectoryModel$0 = function() {
  return new $.DirectoryModel((void 0), (void 0));
};
...
$.Element$html = function(html) {
  ...
  if (!(match === (void 0))) {
    ...
    parentTag = 'div';
    if ($.CTC9.containsKey$1(tag0) === true) {
      parentTag = $.CTC9.operator$index$1(tag0);
    }
    tag = tag0;
  }
...
$.$defineNativeClass('Element', ["innerHTML!"], {
 ...
 get$click: function() { return new $.Closure29(this); },
 get$$$dom_lastElementChild: function() {
...
$.$defineNativeClass('DOMWindow', ["navigator?", "location?", "length?"], {
 ...
 get$open: function() { return new $.Closure37(this); },
 close$0: function() {
  return this.close();
 },
